...
###### This project contains all the ALX 0x02. AirBnB clone - MySQL group task performed by:
1. Nurudeen Ahmed <https://x.com/0xNuru>
2. Bukky Pase <https://github.com/pasebukky>

The tasks are as follows:

## Task 2 - console.py, models/, tests/ ##
...
## Task 6 - models/base_model.py, models/city.py, models/state.py, models/engine/db_storage.py, models/__init__.py ##
...
## Task 10 - models/amenity.py, models/place.py ##
